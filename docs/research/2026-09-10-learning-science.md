...
4. Two correct in a row jumps to 10 to 14 days, then about 21 days; retire from daily drill after three correct recalls at wide gaps. Rawson and Dunlosky 2011 found three correct recalls then three spaced relearnings the efficient point [S49]; Cepeda found 21 days optimal for a 70-day horizon (S7).
